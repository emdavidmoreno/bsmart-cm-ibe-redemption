    ...
    getRequireConfig: function () {
        return {
                options: {
                    ...
                    shim: {},
                    include: [
                        './modules/ibe-confirmation-hold/scripts/init',
                        './modules/ibe-confirmation-hold/scripts/app'
                    ],
                    out: '<%= package.directories.deploy %>/app/modules/bsmart-cm-ibe-redemption/modules/ibe-confirmation-hold/module.dist.js',
