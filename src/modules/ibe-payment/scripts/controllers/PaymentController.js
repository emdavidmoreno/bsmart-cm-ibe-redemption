...
define([
  ...
  bsItineraryPricingCardPerPassenger, bsDetailSeatsPricesComponent) {
  let wrapperInstance = {}
  $.noConflict(true)
    ...
    function PaymentController($scope, hostUIService,
      ...
      let autoFillCardForm = function() {
        $timeout(function() {
          ...
          let v
          v = hostScrapService.getCreditCardValueByInput(inputsType.CARD_TYPE)
      ...
      function buildAgreements() {
        return {
          ...
          checkBoxCreditCardStatus: function() {
            let value = hostScrapService.getAgreementsValueByInput('CREDIT_CARD')
            return value
          },
