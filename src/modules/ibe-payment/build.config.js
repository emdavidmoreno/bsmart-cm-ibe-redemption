    ...
    getRequireConfig: function () {
        return {
                options: {
                    ...
                    shim: {},
                    include: [
                        './modules/ibe-payment/scripts/init',
                        './modules/ibe-payment/scripts/app'
                    ],
                    out: '<%= package.directories.deploy %>/app/modules/bsmart-cm-ibe-redemption/modules/ibe-payment/module.dist.js',
