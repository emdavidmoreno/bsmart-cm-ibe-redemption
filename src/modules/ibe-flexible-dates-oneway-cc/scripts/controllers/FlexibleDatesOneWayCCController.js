...
define([
  ...
  'statsService',
  'lodash',
  '../../../../components/complex/bs-flexible-dates-prices-oneway/index.component',
  ...
  (function() {
     ...
     * @return {Object}
     */
    function FlexibleDatesOneWayCCController(
      $scope,
      hostScrapService,
      hostProxyService,
      $timeout,
      ...
      instance.init = function() {
        console.log('FlexibleDatesOneWayCCController init')
      }
    ...
    FlexibleDatesOneWayCCController.$inject = [
      '$scope',
      'hostScrapService',
      'hostProxyService',
      '$timeout',
    ...
    angular
        ...
        .controller('FlexibleDatesOneWayCCController', FlexibleDatesOneWayCCController)
  })({})
