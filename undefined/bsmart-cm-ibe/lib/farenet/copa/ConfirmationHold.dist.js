       ...
       if (!window.Farenet) {
          ...
          */
          ...
          function getDisclaimers() {
            var container = $('.componentBody .footnote'),
          ...
          function getJourneyType() {
            ...
            if (flights.length === 1) {
              ...
              if (location[0].user_input_destination_airport_code === location[1].user_input_origin_airport_code &&
                  location[0].user_input_origin_airport_code === location[1].user_input_destination_airport_code) {
          ...
          function getDatasource() {
            var step = 'ibe-confirmation';
            var referrer = document.referrer;
            if($('#reserved_and_held') && $('#reserved_and_held').text().length > 0){
              step = 'ibe-confirmation-hold';
            }
            return {
              step: step,
              type: 'default',
